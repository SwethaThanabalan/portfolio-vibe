...
export const projects: Project[] = [
  {
    ...
    descriptor: 'AI-Assisted Home Maintenance Product',
    keywords: ['Product Design', 'User Research', 'AI UX', 'Interaction Design', 'Information Architecture', 'Prototyping', 'Usability Testing'],
    result: 'Research-driven pivot from marketplace to AI guidance product. Validated with user testing.',
    year: '2025',
    thumbnail: '/SAHAY(3).png',
    description: 'Designed an AI home maintenance companion that shifted from marketplace to guidance platform after user research revealed homeowners need confidence, not contractor listings. Led product strategy, research, and interaction design across a 3-person team.',
  ...
  },
  {
    ...
    descriptor: 'Mobile Game Product Experience',
    keywords: ['Product Design', 'User Research', 'A/B Testing', 'Interaction Design', 'Prototyping', 'Mobile UX'],
    result: '4 recommendations shipped in the live product.',
    year: '2024',
    thumbnail: 'MonsterWalkCover.png',
    description: 'Designed a behavioral re-entry strategy for a fitness gaming app during beta. Conducted concept testing with lapsed users, identified emotional hesitation as the retention barrier, and four of my recommendations shipped in the live product.',
  ...
  },
  {
    ...
    category: 'Product Design',
    descriptor: 'Gamified Learning Product Design',
    keywords: ['End-to-End Product Design', 'Design Systems', 'Prototyping', 'Usability Testing', 'Cross-Functional Collaboration'],
    result: 'Design system currently used in the Unity alpha build. 75% validation signal in testing.',
    year: '2024',
    thumbnail: 'AdultYouLogLight.png',
    description: 'Sole designer on a 0-to-1 gamified learning platform. Built a custom design system for Unity integration, restructured text-heavy modules into interactive flows, and validated direction through testing with 20 participants.',
    role: 'Product Designer',
  ...
  },
  {
    ...
    category: 'Product Design',
    descriptor: 'Mobile Transit Experience Redesign',
    keywords: ['UX Design', 'Information Architecture', 'Usability Testing', 'User Flows', 'Prototyping', 'Mobile UX'],
    result: 'SEPTA later shipped the same features: map integration, biometric login, predictive search.',
    year: '2024',
    thumbnail: 'NextStopBetterSEPTAExperience.png',
    description: 'Redesigned SEPTA\'s mobile transit app based on interviews with 8 daily commuters. Introduced map-first navigation, biometric login, and predictive search. SEPTA later launched a revamped app with the same features I identified.',
    role: 'Product Designer',
    duration: '3 months',
